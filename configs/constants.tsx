...
// This will be set dynamically based on language
export let onBoardingSlides: onBoardingSlidesTypes[] = [];

export const getOnBoardingSlides = (t: (key: string) => string): onBoardingSlidesTypes[] => {
  return [
    {
      color: "#ffffff",
      backgroundImage: "https://sasl.imgix.net/s/img/sasl-certification/bg-r.png",
      title: t("onboarding.explore"),
      image: (
        <Image
          source={{ uri: "https://sasl.imgix.net/s/img/sabar/SASL-New-HomePage-content/Group6.svg" }}
          style={{
            width: IsIPAD ? verticalScale(220) : verticalScale(240),
            height: IsIPAD ? verticalScale(220) : verticalScale(240),
          }}
          resizeMode="contain"
        />
      ),
      secondTitle: t("onboarding.ourCommunity"),
      subTitle: t("onboarding.exploreSubtitle"),
    },
    {
      color: "#2A5D84",
      backgroundImage: "https://sasl.imgix.net/s/img/sasl-certification/bg-l.png",
      title: t("onboarding.setYour"),
      image: (
        <Image
          source={{ uri: "https://sasl.imgix.net/s/img/sasl-certification/bitmap.png" }}
          style={{
            width: IsIPAD ? scale(220) : scale(240),
            height: IsIPAD ? verticalScale(220) : verticalScale(240),
          }}
          resizeMode="contain"
        />
      ),
      secondTitle: t("onboarding.ownGoal"),
      subTitle: t("onboarding.goalSubtitle"),
    },
    {
      color: "#1e7bb9",
      backgroundImage: "https://sasl.imgix.net/s/img/sasl-certification/bg-r.png",
      title: t("onboarding.completeFull"),
      image: (
        <Image
          source={{ uri: "https://sasl.imgix.net/s/img/sasl-certification/bitmap.png" }}
          style={{
      ...
      secondTitle: t("onboarding.course"),
      subTitle: t("onboarding.courseSubtitle"),
    },
  ];
};
